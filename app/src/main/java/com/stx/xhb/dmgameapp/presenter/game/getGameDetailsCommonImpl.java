...
public class getGameDetailsCommonImpl extends BasePresenter<getGameDetailsCommonContract.getGameDetailsDataView> implements getGameDetailsCommonContract{
    @Override
